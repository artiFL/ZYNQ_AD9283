...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set ADC_CLOCK_OUT [ create_bd_port -dir O -type clk ADC_CLOCK_OUT ]
  set ADC_DATA_IN [ create_bd_port -dir I -from 7 -to 0 ADC_DATA_IN ]
  set pin_flag_in [ create_bd_port -dir I -type data pin_flag_in ]

  # Create instance: AD9283_0, and set properties
  set AD9283_0 [ create_bd_cell -type ip -vlnv user.org:user:AD9283:1.0 AD9283_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins AD9283_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net AD9283_0_adc_clk [get_bd_ports ADC_CLOCK_OUT] [get_bd_pins AD9283_0/adc_clk]
  connect_bd_net -net ADC_DATA_IN_1 [get_bd_ports ADC_DATA_IN] [get_bd_pins AD9283_0/adc_input_data]
  connect_bd_net -net pin_flag_in_1 [get_bd_ports pin_flag_in] [get_bd_pins AD9283_0/pin_flag]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins AD9283_0/clk] [get_bd_pins AD9283_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins AD9283_0/reset_n_adc] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins AD9283_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x43C00000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs AD9283_0/S00_AXI/S00_AXI_reg] SEG_AD9283_0_S00_AXI_reg
