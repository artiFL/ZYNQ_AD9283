...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_AD9283_v1_0_S00_AXI is
  ...
  attribute SOFT_HLUTNM of \slv_reg0[31]__0_i_2\ : label is "soft_lutpair1";
begin
  ADC_CLK <= \^adc_clk\;
...
clock_i_1: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\slv_reg0[15]__0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0020"
    )
        port map (
...
\slv_reg0[23]__0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0020"
    )
        port map (
...
\slv_reg0[31]__0_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"0020"
    )
        port map (
